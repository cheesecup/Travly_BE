...
class EmitterRepositoryImplTest {
    ...
    public void saveEventCache() throws Exception {
        ...
        Notification notification = new Notification("플랜 초대가 왔습니다.", "url", false, NotificationType.INVITE, new Member(null,null,null,null,null,null,null,null,null,null));
    ...
    public void findAllEventCacheStartWithByMemberId() throws Exception {
        ...
        Notification notification1 = new Notification("플랜 초대가 왔습니다.", "url", false, NotificationType.INVITE, new Member(null,null,null,null,null,null,null,null,null,null));
        emitterRepository.saveEventCache(eventCacheId1, notification1);

        Thread.sleep(100);
        String eventCacheId2 =  memberId + "_" + System.currentTimeMillis();
        Notification notification2 = new Notification("플랜 초대가 승인되었습니다.", "url", false, NotificationType.AGREE, new Member(null,null,null,null,null,null,null,null,null,null));
        emitterRepository.saveEventCache(eventCacheId2, notification2);

        Thread.sleep(100);
        String eventCacheId3 =  memberId + "_" + System.currentTimeMillis();
        Notification notification3 = new Notification("플랜 초대가 거절되었습니다.", "url", false, NotificationType.DISAGREE, new Member(null,null,null,null,null,null,null,null,null,null));
    ...
    @Test
    @DisplayName("수신한 이벤트를 캐시에서 모두 제거한다.")
