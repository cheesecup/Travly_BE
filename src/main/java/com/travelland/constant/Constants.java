...
public final class Constants {
    ...
    public static final String SEARCH_RANK_FIELD = "keyword";

    public static final String TRIP_AREA_MAP = "서울_서울특별시,서울시/경기_경기도/인천_인천시,인천특별시/강원_강원도/" +
            "대전_대전광역시,대전시/충북충남_충북,충남,충청도,충청북도,충청남도/경북경남_경북,경상북도,경남,경상남도,경상,경상도/" +
            "부산_부산광역시,부산시/울산_울산시,울산광역시/전북전남_전북,전라북도,전남,전라남도,전라도,전라/제주_제주시,제주도,제주특별시";
}